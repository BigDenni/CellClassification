...
class Detection(Task):
    ...
    def read_training_sets(self, train_dir, label_dir):
        ...
        det_data.vallabels = det_data.vallabels * 100
    ...
    def validate(self, image, original, index, resultsdir, patchflag=False, patchsize=100):
